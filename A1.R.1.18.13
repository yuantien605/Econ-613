...
# Mig2$change <- identical(Mig2$empstat, lag(Mig2$empstat))

# Mig$change <- (Mig$ != lag(df$value))

# length(unique(Mig$idmen)) #find how many households that match all the conditions
